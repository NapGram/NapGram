 ...
 * 消息片段（统一的消息表示）
 */
export type MessageSegment = TextSegment | AtSegment | ReplySegment | ImageSegment | VideoSegment | AudioSegment | FileSegment | ForwardSegment | FaceSegment | RawSegment;
