...
export class MediaSender {
        ...
        for (const media of mediaItems) {
            try {
                ...
                const fileName = (media as any).data.fileName ||
                    (typeof (media as any).data.file === 'string' ? (media as any).data.file :
     ...
     */
    async sendLocationToTG(chat: any, content: MessageContent, replyTo?: number, messageThreadId?: number, header?: string, richHeaderUsed?: boolean, richHeaderUrl?: string) {
     ...
     */
    async sendDiceToTG(chat: any, content: MessageContent, replyTo?: number, messageThreadId?: number, header?: string, richHeaderUsed?: boolean, richHeaderUrl?: string, pair?: any) {
