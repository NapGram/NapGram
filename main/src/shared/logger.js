...
function buildDatedFile(dateStr) {
...
function formatArgs(args, color = false) {
...
function logToConsole(logger, level, args) {
...
function logToFile(logger, level, args) {
    if (!fileLoggingEnabled || !fileStream)
        return;
