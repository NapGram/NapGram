...
declare const kit: {
    env: {
        DATA_DIR: string;
        CACHE_DIR: string;
        LOG_LEVEL: "error" | "debug" | "info" | "warn" | "off" | "trace" | "fatal" | "mark";
        LOG_FILE_LEVEL: "error" | "debug" | "info" | "warn" | "off" | "trace" | "fatal" | "mark";
        LOG_FILE: string;
        OICQ_LOG_LEVEL: "error" | "debug" | "info" | "warn" | "off" | "trace" | "fatal" | "mark";
        TG_LOG_LEVEL: "error" | "debug" | "info" | "warn" | "none";
        TG_API_ID: number;
        TG_API_HASH: string;
        TG_BOT_TOKEN: string;
