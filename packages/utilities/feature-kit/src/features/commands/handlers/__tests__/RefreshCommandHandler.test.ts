...
describe('refreshCommandHandler', () => {
  ...
  describe('/refresh command', () => {
    ...
    describe('error Scenarios', () => {
      ...
      it('should reject private QQ friend bindings', async () => {
        ...
        expect(mockContext.replyTG).toHaveBeenCalledWith(
          '777777',
          expect.stringContaining('绑定的是 QQ 好友'),
          undefined,
        )
      })
  ...
  describe('/refresh_all command', () => {
    beforeEach(() => {
      mockContext.instance.forwardPairs.getAll = vi.fn().mockReturnValue([
        ...
        { id: 4, qqChatType: 'private', qqRoomId: '222222', tgChatId: '444444' },
      ])
    })
    ...
    it('should refresh all bound groups', async () => {
      ...
      expect(mockQQClient.getGroupInfo).not.toHaveBeenCalledWith('222222')
    })
